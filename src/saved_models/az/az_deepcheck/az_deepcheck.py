...
'''
az-deepcheck	train set 0.881178283 test set	0.876129361

'''


class AZ_DEEPCHECK(az_dataset):

    def __init__(self):
        super(AZ_DEEPCHECK, self).__init__()
...
if __name__ == '__main__':
    ...
    if model == 'TRAIN':
        ...
        az.train_model(train=True,
                       kernel_path='/src/saved_models/az/az_deepcheck/az_deepcheck.h5',
                       model_path='/src/saved_models/az/az_deepcheck/az_deepcheck.json',
    ...
    if model == 'LOAD':
        ...
        print(len(model_object.get_Xtrain()))
        print(len(model_object.get_Xtest()))
        numseed = None
        ...
        print(f'correct_predictions / ({numseed})= {correct_predictions}')
