...
if __name__ == '__main__':
    ...
    if model == 'TRAIN':
        ...
        mnist.train_model(train=True,
                          kernel_path=f'{SRC_ROOT}/saved_models/fashionmnist/fashionmnist_deepcheck/fashionmnist_deepcheck.h5',
                          model_path=f'{SRC_ROOT}/saved_models/fashionmnist/fashionmnist_deepcheck/fashionmnist_deepcheck.json',
    ...
    if model == 'LOAD':
        # load model
        name_model = "fashionmnist_deepcheck"
