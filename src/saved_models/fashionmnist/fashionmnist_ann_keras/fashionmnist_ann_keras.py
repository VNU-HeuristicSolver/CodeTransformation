...
if __name__ == '__main__':
    ...
    if model == 'TRAIN':
        ...
        mnist.train_model(train=True,
                          kernel_path=f'{SRC_ROOT}/saved_models/fashionmnist/fashionmnist_ann_keras/fashionmnist_ann_keras.h5',
                          model_path=f'{SRC_ROOT}/saved_models/fashionmnist/fashionmnist_ann_keras/fashionmnist_ann_keras.json',
    ...
    if model == 'LOAD':
        # load model
        name_model = "fashionmnist_ann_keras"
