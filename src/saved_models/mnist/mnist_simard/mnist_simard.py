...
if __name__ == '__main__':
    ...
    if model == 'TRAIN':
        ...
        mnist.train_model(train=True,
                          kernel_path=f'{SRC_ROOT}/saved_models/mnist/mnist_simard/mnist_simard.h5',
                          model_path=f'{SRC_ROOT}/saved_models/mnist/mnist_simard/mnist_simard.json',
