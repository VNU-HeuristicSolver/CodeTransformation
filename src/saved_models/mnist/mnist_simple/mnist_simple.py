...
if __name__ == '__main__':
    ...
    if model == 'TRAIN':
        ...
        mnist.train_model(train=True,
                          kernel_path=f'{SRC_ROOT}/saved_models/mnist/mnist_simple/mnist_simple.h5',
                          model_path=f'{SRC_ROOT}/saved_models/mnist/mnist_simple/mnist_simple.json',
    ...
    if model == 'LOAD':
        ...
        x_train, y_train = mnist.get_an_observation(index=2)
