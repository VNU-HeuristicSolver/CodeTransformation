...
if __name__ == '__main__':
    model_object =  initialize_dnn_model_from_name("mnist_deepcheck")
    ...
    for layer in model_object.get_model().layers[:presoftmax]:
        ...
        if keras_layer.is_activation(layer) and keras_activation.is_relu(layer):
            ...
            for jdx in range(num_neuron):
                ...
                # save name of neuron
                name_neuron = get_neuron_name(layer_idx, jdx, model)
    ...
    suspicious_file = "/Users/ducanhnguyen/Documents/mydeepconcolic/suspicious_neuron_mnistdeepcheck.csv"
