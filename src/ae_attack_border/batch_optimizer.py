...
def export_summaryv2(oris_0_255, advs_0_255, adv_idxes, optimized_advs, target_label, ori_label, output_folder,
                     epsilons):
    L0_before = utilities.compute_l0s(advs_0_255, oris_0_255, n_features=N_FEATURES, scale_0_255=True)
    L2_before = utilities.compute_l2s(advs_0_255, oris_0_255, n_features=N_FEATURES)
    L0_after = utilities.compute_l0s(optimized_advs, oris_0_255, n_features=N_FEATURES, scale_0_255=True)
