...
if __name__ == '__main__':
    ...
    for model in MODELS:
        ...
        for K in Ks:
            ...
            IMAGES = f'/Users/ducanhnguyen/Documents/NpixelAttackDeepFault/data/proposal/out_ssim'
            ...
            for idx, row in enumerate(rows):
                ...
                # print(path)
                # ssim = str(ssim).replace("0.","")
                path = f'{IMAGES}/{ssim}.png'
                print(path)
